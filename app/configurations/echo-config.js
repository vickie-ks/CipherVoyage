export let ECHO_ARTICLES = {
  title: 'Voyages in Fiction',
  description: 'Immerse yourself in tales of intrigue and imagination.',
  ...
  articlesList: [
    {
      ...
      filePath: '_echoes/journey_to_new_horizons.md',
